...
return function (App $app) {
    ...
    $app->get('/volontulo/{id:.+}', VolunteerController::class . ':getProfile');
    $app->get('/organizanto/{id:.+}', OrganizerController::class . ':getProfile');

    $app->get('/tasko/{id:.*}', TaskController::class . ':get');
    ...
    $app->group('', function (RouteCollectorProxy $group) {
        ...
        $group->get('/registrigxi/retposxto', PageController::class . ':get');
        $group->post('/registrigxi/retposxto', AccountController::class . ':signup');
