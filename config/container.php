...
return [
    ...
    OrganizerProfileController::class => create(OrganizerProfileController::class)
        ->constructor(
            twig: get(Twig::class),
            session: get(SessionInterface::class),
            sessionManager: get(SessionManagerInterface::class),
            contentRepository: get(ContentRepository::class),
            organizerProfilesRepository: get(OrganizerProfilesRepository::class),
        ),
    ...
    VolunteerProfileController::class => create(VolunteerProfileController::class)
        ->constructor(
            twig: get(Twig::class),
            session: get(SessionInterface::class),
            sessionManager: get(SessionManagerInterface::class),
            accountsRepository: get(AccountsRepository::class),
            contentRepository: get(ContentRepository::class),
            volunteerProfilesRepository: get(VolunteerProfilesRepository::class),
        ),
    ...
    OrganizerProfilesRepository::class => create(OrganizerProfilesRepository::class)
        ->constructor(
            db: get(DbAccess::class),
        ),
    ...
    VolunteerProfilesRepository::class => create(VolunteerProfilesRepository::class)
        ->constructor(
            db: get(DbAccess::class),
        ),
