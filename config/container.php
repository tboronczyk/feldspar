...
return [
    ...
    AccountController::class => create(AccountController::class)
        ->constructor(
            ...
            accountsRepository: get(AccountsRepository::class),
            contentRepository: get(ContentRepository::class),
            organizersRepository: get(OrganizersRepository::class),
            passwordsRepository: get(PasswordsRepository::class),
            volunteersRepository: get(VolunteersRepository::class),
        ),
    ...
    OAuth2Controller::class => create(OAuth2Controller::class)
        ->constructor(
            ...
            accountsRepository: get(AccountsRepository::class),
            contentRepository: get(ContentRepository::class),
            oAuth2AccountsRepository: get(OAuth2AccountsRepository::class),
            organizersRepository: get(OrganizersRepository::class),
            volunteersRepository: get(VolunteersRepository::class),
        ),

    OrganizerController::class => create(OrganizerController::class)
        ->constructor(
            twig: get(Twig::class),
            session: get(SessionInterface::class),
            sessionManager: get(SessionManagerInterface::class),
            contentRepository: get(ContentRepository::class),
            organizersRepository: get(OrganizersRepository::class),
            tasksRepository: get(TasksRepository::class),
        ),
    ...
    PasswordController::class => create(PasswordController::class)
        ->constructor(
            ...
            accountsRepository: get(AccountsRepository::class),
            contentRepository: get(ContentRepository::class),
            otpTokensRepository: get(OtpTokenRepository::class),
            passwordsRepository: get(PasswordsRepository::class),
        ),

    TaskController::class => create(TaskController::class)
        ->constructor(
            twig: get(Twig::class),
            session: get(SessionInterface::class),
            sessionManager: get(SessionManagerInterface::class),
    ...
    VolunteerController::class => create(VolunteerController::class)
        ->constructor(
            twig: get(Twig::class),
            session: get(SessionInterface::class),
            sessionManager: get(SessionManagerInterface::class),
    ...
    OAuth2AccountsRepository::class => create(OAuth2AccountsRepository::class)
        ->constructor(
            db: get(DbAccess::class),
        ),

    OrganizersRepository::class => create(OrganizersRepository::class)
        ->constructor(
            db: get(DbAccess::class),
        ),
    ...
    TasksRepository::class => create(TasksRepository::class)
        ->constructor(
            db: get(DbAccess::class),
        ),

    VolunteersRepository::class => create(VolunteersRepository::class)
        ->constructor(
            db: get(DbAccess::class),
        ),
